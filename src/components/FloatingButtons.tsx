...
const FloatingButtons = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {/* Animated panel */}
      <div
        className={`mt-3 flex flex-col items-end gap-3 transition-all duration-300 ${
      ...
      >
        ...
        <a
          ...
          target="_blank"
          className="flex items-center gap-3 bg-green-600 hover:bg-green-500 text-white py-2 pl-4 pr-3 rounded-full shadow-lg"
        >
        ...
        <a
          ...
          className="flex items-center gap-3 bg-yellow-500 hover:bg-yellow-400 text-black py-2 pl-4 pr-3 rounded-full shadow-lg"
        >
        ...
        <a
          ...
          target="_blank"
          className="flex items-center gap-3 bg-blue-600 hover:bg-blue-500 text-white py-2 pl-4 pr-3 rounded-full shadow-lg"
        >
